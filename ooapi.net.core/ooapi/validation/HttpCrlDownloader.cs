...
namespace org.openoces.ooapi.validation
{
    public class HttpCrlDownloader : IHttpCrlDownloader
    {
        ...
        public HttpCrlDownloader(TimeService timeService, IHttpClient httpClient, IX509CrlVerifyImpl x509CrlVerifyImpl)
        {
        ...
        {
            return new Crl(await _httpClient.Download(location),_timeService, _x509CrlVerifyImpl);
        }
    }
}
